...
/* 테이블에 데이터를 삽입(INSERT) 하는 첫 번째 방법 : 테이블 목록과 추가 할 값을 모두 표기 하는 방법*/
...
INSERT INTO DEPT_TEMP(DEPTNO, LOC) VALUES (10, 'ULSAN');

/*EMP TABLE만 복사하고 내용은 복사하지 않음*/
CREATE TABLE EMP_TEMP
AS SELECT * FROM EMP
WHERE 1 != 1; -- 테이블을 복사하면서 데이터는 복사하고 싶지 않을 때 사용

SELECT * FROM EMP_TEMP;
/*날짜 데이터는 '2020/01/01', '2023-01-01' 입력 가능
* TO_DATE('2021/02/01, 'YYYY/MM/DD')
*/
INSERT INTO EMP_TEMP(EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, COMM, DEPTNO)
VALUES(9005, '카즈하', 'MANAGER',9999,SYSDATE, 7700, 300, 40);
...
--많은 급여를 받고 있는 사원들을 70번 부서로 옮기는 SQL문을 작성하세요.
UPDATE EX_EMP
SET DEPTNO = 70
WHERE SAL > (SELECT AVG(SAL)
            ...
            SELECT * FROM EX_EMP;
            ORDER BY DEPTNO;
--4. EX_EMP에 속한 사원 중, 60번 부서의 사원 중에 입사일이 가장 빠른 사원보다 
--늦게 입사한 사원의 급여를 10% 인상하고 80번 부서로 옮기는 SQL문을 작성하세요.
UPDATE EX_EMP
