...
public class IpadProMake {
   ...
   private String serialNum; // 제품 일련 번호 : ipad13128C2301121
    static int cnt = 0; // 클래스 변수 : 객체 생성되지 않고 클래스 생성 시 만들어짐
    ...
    IpadProMake(String name) {
        ...
        cnt++; // 생성자는 객체가 만들어 질 때 호출 되므로 생성된 객체의 횟수를 확인하는 ㅇ용도로 사용 할 수 있음
...
public void setNetwork(){
        Scanner sc = new Scanner(System.in);
        while(true) {
            System.out.print("네트워크 선택 [1]Wi-Fi [2]Wi-fi+Celluclar : ");
            network = sc.nextInt();
