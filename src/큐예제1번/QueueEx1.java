...
// add(e) : 맨 뒤에 요소를 삽입 (중간 삽입 안 됨) - 예외 발생
// offer(e) : 맨 뒤에 요소를 삽입 - true/false
// remove() : 맨 앞 요소 제거 - 예외 발생
// poll() : 맨 앞 요소 제거 - 비어 있으면 null
// element() : 맨 앞 요소 읽어옴 - 예외 발생
// peek() : 맨 앞 요소를 읽어옴 - 큐가 비어있으면 null
...
public class QueueEx1 {
    public static void main(String[] args) {
        ...
        while (!msgQ.isEmpty()) {
            Message msg = msgQ.poll();// 큐에서 한 개의 메시지를 꺼냄(맨앞)
            switch (msg.command) {
                case "Mail" :
