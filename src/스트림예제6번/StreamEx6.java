...
public class StreamEx6 {
    public static void main(String[] args) {
        ...
        // reduce() : 첫 번째 요소와 두 번째 요소를 가지고 연산을 수행 후, 그 결과와 세 번째 요소를 가지고 다시 연산
        ...
        OptionalInt rst3 = stream5.sorted().findAny(); // 병렬처리 관련 내용이 포함되어 있ㅇ어서 요소의 첫번째 값이 아닌 경우가 있음
        System.out.println(rst3.getAsInt());

        //요소의 검사 :
        // anyMatch() : 해당 스트림의 일부 요소가 조건에 만족하면 true
        // allMatch() :  "    모든 "
        // noneMatch() 해당 스트림의 모돈요소가 특정 조건을 만족하지 않을 경우 true
        ...
        DoubleStream stream12 = DoubleStream.of(30.3,90.9,70.11,10.22);
